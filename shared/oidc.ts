 ...
 * Converts all properties of an existing object type to strings.
 *
 * @internal
 *
 * @example
 * Add user facing descriptions to an existing object type.
 *
 * @privateRemarks
 * Used to add field descriptions to TypeGraphQL entities and TypeORM records.
 */
export type ObjectDescription<Type, Keys extends keyof Type> = Pick<
  Required<{
...
export namespace OidcClaims {
   ...
   *
   * @public
   * @see {@link https://datatracker.ietf.org/doc/html/rfc7519#section-4.1|JWT Claims}
   */
   ...
   *
   * @public
   * @see {@link https://openid.net/specs/openid-connect-core-1_0.html#IDToken|ID Token Claims}
   */
  export interface IdTokenClaims
    extends Mandatory<OidcClaims.Standard, "sub">,
      Mandatory<OidcClaims.Jwt, "iss" | "sub" | "aud" | "exp" | "iat"> {
    [claim: string]: unknown;
